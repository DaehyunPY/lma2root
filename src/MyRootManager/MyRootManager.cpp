  ...
  if (!oet) {
    ...
    if (fn.CompareTo("") != 0) {
      if (fn.EndsWith(".root")) {
        ...
        std::cout << "We are not creating a File and Tree for Original Event since the provided filename (" << fn.Data()
                  << ") misses a .root fileending!" << std::endl;
    }
  }
  if (!saet) {
    ...
    if (fn.CompareTo("") != 0) {
      if (fn.EndsWith(".root")) {
        ...
        std::cout << "We are not creating a File and Tree for Signal Analyzed Event since the provided filename ("
                  << fn.Data() << ") misses a .root fileending!" << std::endl;
    }
  }
  if (!set) {
    ...
    if (fn.CompareTo("") != 0) {
      if (fn.EndsWith(".root")) {
        ...
        std::cout << "We are not creating a File and Tree for Sorted Event since the provided filename (" << fn.Data()
                  << ") misses a .root fileending!" << std::endl;
    }
  }
