...
class MyRawEventViewer : public MyEventViewerBase {
 ...
 private:
  template<typename T>
  void showEventImpl(const MyOriginalEvent &, const MySignalAnalyzedEvent &);
  template<typename T>
  void showEventImplBLCorr(const MyOriginalEvent &, const MySignalAnalyzedEvent &);
};
...
class MyCFDAdjuster : public MyEventViewerBase {
 ...
 private:
  template<typename T>
  void adjustCfdImpl(const MyOriginalEvent &, MySignalAnalyzedEvent &, const MySignalAnalyzer &);
};
