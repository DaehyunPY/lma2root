...
public:
    ...
    bool init(sort_class * mother_sort_instance);				// FUNCTION
...
private:
    double calibrate(double fv, double fw, double w_offset);  // FUNCTION
...
//	virtual bool expand_an_hit_array(hit_class**[], __int32 * , __int32); // FUNCTION
	...
	__int32 init(); // FUNCTION
	void get_error_text(__int32 error_code,__int32 buffer_length,char* destination_array);

    double correct_sum(double t1, double t2,__int32 number_of_layer);  // FUNCTION
	double correct_pos(double t1, double t2,__int32 number_of_layer);  // FUNCTION
	double get_corrected_anode_signal(double ttmcp, double t,__int32 left_or_right_side, __int32 layer);  // FUNCTION
