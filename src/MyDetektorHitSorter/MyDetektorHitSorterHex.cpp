...
MyDetektorHitSorterHex::MyDetektorHitSorterHex(const MyDetektorInfo &di, MyHistos &rm, int HiOff) :
  ...
  rm.create2d(fHiOff + kDetUVRaw_ns,
              "DetUVRaw_ns",
              "x [ns]",
              "y [ns]",
              300,
              ...
              maxpos_ns,
              Form("%s/DetPictures", di.GetName()));
  rm.create2d(fHiOff + kDetVWRaw_ns,
              "DetVWRaw_ns",
              "x [ns]",
              "y [ns]",
              300,
              ...
              maxpos_ns,
              Form("%s/DetPictures", di.GetName()));
  rm.create2d(fHiOff + kDetUWRaw_ns,
              "DetUWRaw_ns",
              "x [ns]",
              "y [ns]",
              300,
  ...
  rm.create2d(fHiOff + kDetRaw_mm,
              ...
              maxpos_mm,
              Form("%s/DetPictures", di.GetName()));
  rm.create2d(fHiOff + kDetUVRaw_mm,
              "DetUVRaw_mm",
              "x [mm]",
              "y [mm]",
              300,
              ...
              maxpos_mm,
              Form("%s/DetPictures", di.GetName()));
  rm.create2d(fHiOff + kDetVWRaw_mm,
              "DetVWRaw_mm",
              "x [mm]",
              "y [mm]",
              300,
              ...
              maxpos_mm,
              Form("%s/DetPictures", di.GetName()));
  rm.create2d(fHiOff + kDetUWRaw_mm,
              "DetUWRaw_mm",
              "x [mm]",
              "y [mm]",
              300,
              ...
              Form("%s/DetPictures", di.GetName()));
  //ratio//
  rm.create1d(fHiOff + kNbrRecHits,
              "NbrRecHits",
              "Nbr of Reconstructed Hits",
              2000,
              0,
              1000,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kNbrMCPHits,
              "NbrMCPHits",
              "Nbr of MCP Hits",
              2000,
              0,
  ...
  rm.create1d(fHiOff + kU1MCPRatio,
              "U1MCPRatio",
              "U1 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kU2MCPRatio,
              "U2MCPRatio",
              "U2 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kV1MCPRatio,
              "V1MCPRatio",
              "V1 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kV2MCPRatio,
              "V2MCPRatio",
              "V2 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kW1MCPRatio,
              "W1MCPRatio",
              "W1 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kW2MCPRatio,
              "W2MCPRatio",
              "W2 Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kMCPRecRatio,
              "MCPRecRatio",
              "Reconstructed Hits / MCP Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kU1RecRatio,
              "U1RecRatio",
              "Reconstructed Hits / U1 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kU2RecRatio,
              "U2RecRatio",
              "Reconstructed Hits / U2 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kV1RecRatio,
              "V1RecRatio",
              "Reconstructed Hits / V1 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kV2RecRatio,
              "V2RecRatio",
              "Reconstructed Hits / V2 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kW1RecRatio,
              "W1RecRatio",
              "Reconstructed Hits / W1 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
  rm.create1d(fHiOff + kW2RecRatio,
              "W2RecRatio",
              "Reconstructed Hits / W2 Hits",
              100,
              0,
              4,
              Form("%s/InputOutputRatio", di.GetName()));
