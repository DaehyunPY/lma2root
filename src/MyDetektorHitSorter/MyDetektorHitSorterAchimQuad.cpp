	...
	MyDetektorHitSorterQuad(di,rm,HiOff), MyDetektorHitSorterAchim(di)
{
	...
	//timesums//
	rm.create2d(fHiOff+kSumVsUShift		,"SumVsXShift"	  ,"x [ns]","xsum [ns]",300,-maxpos_ns,maxpos_ns,300,-10,+10,Form("%s/Timesums",di.GetName()));
	rm.create2d(fHiOff+kSumVsVShift		,"SumVsYShift"	  ,"y [ns]","ysum [ns]",300,-maxpos_ns,maxpos_ns,300,-10,+10,Form("%s/Timesums",di.GetName()));
	rm.create2d(fHiOff+kSumVsUShiftCorr	,"SumVsXShiftCorr","x [ns]","xsum [ns]",300,-maxpos_ns,maxpos_ns,300,-10,+10,Form("%s/Timesums",di.GetName()));
	rm.create2d(fHiOff+kSumVsVShiftCorr	,"SumVsYShiftCorr","y [ns]","ysum [ns]",300,-maxpos_ns,maxpos_ns,300,-10,+10,Form("%s/Timesums",di.GetName()));
	//det//
