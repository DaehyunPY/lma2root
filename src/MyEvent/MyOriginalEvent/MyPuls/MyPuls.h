...
class MyPuls {
 ...
 private:
  ...
  long
      fIdxFiPOrig;                                    //index to first point in the whole trace in units of the original data type
  long
      fIdxFiPComp;                                    //index to first point in the zero supressd trace in units of the char waveform
