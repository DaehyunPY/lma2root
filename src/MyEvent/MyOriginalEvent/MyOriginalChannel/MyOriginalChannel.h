...
class MyOriginalChannel {
 ...
 private:
  ...
  std::vector<char>
      fZeroSuppressedWaveform;                    //a buffer to contain the zero suppressed traces of the pulses
  ...
  double
      fGain;                                        //! the conversion factor from adc bytes to mV (adc bytes * fGain = mV)
