...
class MyOriginalEventInfo : public TObject {
 ...
 private:
  ...
  long
      fNbrSamples;                                    //Nbr of Points (multiplied by the fSampInter it will give the timewindow in ns)
 ...
 ClassDef(MyOriginalEventInfo,
          1)                                                    //Infos about an Event as they are stored in the lma file
};
#endif